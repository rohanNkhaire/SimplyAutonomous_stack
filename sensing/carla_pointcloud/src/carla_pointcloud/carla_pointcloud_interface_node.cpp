...
: Node("carla_pointcloud_interface_node", node_options), tf_output_frame_("ego_vehicle")
{
    carla_cloud_ =
    ...
    velodyne_points_perception =
            this->create_publisher<sensor_msgs::msg::PointCloud2>("/sensing/lidar/pointcloud", rclcpp::SensorDataQoS());
